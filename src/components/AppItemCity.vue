<template>
  <div class="item-city">
    <div class="item-city__wrap">
      <div class="item-city__burger handle">
        <div></div>
        <div></div>
        <div></div>
      </div>
      <div class="item-city__title">{{ cityItem.name }}, <span>{{ cityItem.code }}</span></div>
    </div>
    <div class="item-city__delete" @click="$emit('deleteCity', cityItem.name)">
